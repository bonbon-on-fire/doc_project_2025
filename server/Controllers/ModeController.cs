    ...
    : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<ModesResponse>> GetModes([FromQuery] string userId)
    {
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<ModeDto>> GetMode(string id, [FromQuery] string userId)
    {
        if (string.IsNullOrWhiteSpace(userId))
        {
            return BadRequest(new { Error = "UserId is required" });
    ...
    [HttpDelete("{id}")]
    public async Task<ActionResult> DeleteMode(string id, [FromQuery] string userId)
    {
        if (string.IsNullOrWhiteSpace(userId))
        {
            return BadRequest(new { Error = "UserId is required" });
