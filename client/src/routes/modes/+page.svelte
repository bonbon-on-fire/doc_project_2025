			...
			>
						...
						<div class="mt-3 w-full text-center sm:ml-4 sm:mt-0 sm:text-left">
							...
							<div class="mt-4 space-y-4">
								...
								<div>
									...
									>
										<pre
											class="whitespace-pre-wrap text-sm text-gray-600 dark:text-gray-400">{selectedModeForPreview.prompt}</pre>
									</div>
								</div>
				...
				<div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 dark:bg-gray-900">
					<button
						...
						class="inline-flex w-full justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm dark:bg-blue-500 dark:hover:bg-blue-600"
					>
						Test Mode
					</button>
					<button
						on:click={closePreview}
						class="mt-3 inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 sm:ml-3 sm:mt-0 sm:w-auto sm:text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
					>
						Close
					</button>
				</div>
								...
								{#if importError}
									<div class="mt-4 rounded-lg bg-red-50 p-4 dark:bg-red-900/20">
										<div class="flex">
											...
											<div class="ml-3">
												<p class="whitespace-pre-line text-sm text-red-800 dark:text-red-200">
													{importError}
												</p>
											</div>
										</div>
