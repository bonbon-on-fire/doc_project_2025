...
public class ProtocolNegotiationMiddlewareTests
{
    ...
    public async Task InvokeAsync_WithChatEndpoint_NegotiatesProtocol()
    {
        ...
        context.Request.Headers["User-Agent"] = "Mozilla/5.0 Chrome/120.0";
    ...
    public async Task InvokeAsync_WithLegacyBrowser_SelectsSSE()
    {
        ...
        var context = new DefaultHttpContext();
        context.Request.Path = "/api/chat/send";
        context.Request.Headers["User-Agent"] = "Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.1; Trident/6.0)";
        _featureManager.Setup(x => x.IsEnabledAsync("SignalRMessaging"))
            .ReturnsAsync(true);
    ...
    public async Task InvokeAsync_WithOldEdgeBrowser_SelectsSSE()
    {
        ...
        var context = new DefaultHttpContext();
        context.Request.Path = "/api/chat/send";
        context.Request.Headers["User-Agent"] = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.140 Safari/537.36 Edge/18.17763";
        _featureManager.Setup(x => x.IsEnabledAsync("SignalRMessaging"))
            .ReturnsAsync(true);
    ...
    public async Task InvokeAsync_WithNewEdgeBrowser_SelectsSignalR()
    {
        ...
        var context = new DefaultHttpContext();
        context.Request.Path = "/api/chat/send";
        context.Request.Headers["User-Agent"] = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36 Edg/120.0.0.0";
        _featureManager.Setup(x => x.IsEnabledAsync("SignalRMessaging"))
            .ReturnsAsync(true);
